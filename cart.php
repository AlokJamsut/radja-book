...
<div class="heading">
   <h3>Keranjang </p> Belanja</h3>
   <p> <a href="home.php">Beranda</a> / Keranjang </p>
</div>

<section class="shopping-cart">

   <h1 class="title">Produk Ditambah</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="sub-total"> total belanja : <span>Rp<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>/-</span> </div>
      </div>
      <?php
   ...
   <div class="cart-total">
      <p>total belanja : <span>Rp<?php echo $grand_total; ?>/-</span></p>
      <div class="flex">
         <a href="shop.php" class="option-btn">lanjutkan belanja</a>
         <a href="checkout.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">langsung checkout</a>
      </div>
   </div>
